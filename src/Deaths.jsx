    ...
    return (
        <div className="border-2 h-36 w-48 flex flex-col justify-between">
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <span className='text-sm font-bold text-gray-600'>{results ? results.deaths.total : 'No data'}</span>
            </div>
            <div className="flex flex-col justify-center items-center">
                <h3 className="text-sm">Daily COVID Deaths</h3>
                <span className='text-sm font-bold text-gray-600'>{results ? results.deaths.new : 'No data'}</span>
            </div>
        </div>
    )
}
